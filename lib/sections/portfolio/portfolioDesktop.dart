      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.frederickaTheGreat(fontWeight: FontWeight.w200),
          ),
          SizedBox(
              ...
              itemBuilder: (context, index) {
                return WidgetAnimator(
                  child: ProjectCard(
                    cardWidth: width < 1200 ? width * 0.25 : width * 0.35,
                    cardHeight: width < 1200 ? height * 0.28 : height * 0.1,
                    backImage: kBlogBanner[index],
                    projectIcon: kBlogIcons[index],
                    projectTitle: kBlogTitles[index],
                    projectDescription: kBlogDescriptions[index],
                    //projectLink: kBlogLinks[index],
                    bottomWidget: Container(),
                  ),
                );
              },
